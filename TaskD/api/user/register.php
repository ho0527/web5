<?php
    ...
    class register extends Controller{
        public function register(Request $request){
            ...
            $errors409=["error"=>"MSG_USER_EXISTS","error"=>"MSG_PASSWORD_NOT_SECURE"];
            $errors400=["error"=>"MSG_MISSING_FLELD","error"=>"MSG_WORND_DATA_TYPE","error"=>"MSG_IMAGE_CAN_NOT_PROCESS"];
            // ["error"=>"MSG_MISSING_FLELD"],400,
                    // ["error"=>"MSG_WORND_DATA_TYPE"],400,
                    // ["error"=>"MSG_IMAGE_CAN_NOT_PROCESS"],400,
